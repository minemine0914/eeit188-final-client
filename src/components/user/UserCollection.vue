    ...
    <div class="container">
        ...
        <div class="collection-container">
            ...
            <v-card
                ...
                height="350"
            >
                <v-card-subtitle class="custom-subtitle">{{ house?.name }}</v-card-subtitle>
                <v-card-text class="bg-surface-light pt-4">
                    <div class="image" @click="handleClick(house)">
                        <v-img v-if="house?.images.length === 0" src="src/assets/ImageNotAvailable02.webp"></v-img>
...
async function getUserCollectionHouse(pageNo, pageSize, search) {
    try {
        ...
        collection.collections = response.data.userCollections.map(collection => ({
            ...collection,

                    ...
                    <v-card-text>
                        <v-list dense>
                            <v-list-item>
                                <v-list-item-content>
                                    <v-list-item-title
                                        >房客名稱: {{ reservationRecord.customerName }}</v-list-item-title
                                    >
                                    <v-list-item-subtitle
                                        >入住日期: {{ reservationRecord.stayDate }}</v-list-item-subtitle
                                    >
                                </v-list-item-content>
                            </v-list-item>
                            <v-list-item>
                                <v-list-item-content>
                                    <v-list-item-title
                                        >總金額: {{ reservationRecord.totalAmount }} 元</v-list-item-title
                                    >
                                </v-list-item-content>
                            </v-list-item>
